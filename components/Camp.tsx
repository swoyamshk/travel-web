  ...
  return (
    <section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      <div className="hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        <CampSite backgroundImage='bg-bg-img-1' title="Kathmandu Camp" subtitle="Kathmandu,Nepal" peopleJoined="50+ joined" />
        <CampSite backgroundImage='bg-bg-img-2' title="Mountain View" subtitle="Somewhere in the Mountains" peopleJoined="50+ joined" />
      </div>
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 px:py-20 relative w-full overflow-hidden rounded-3xl">
